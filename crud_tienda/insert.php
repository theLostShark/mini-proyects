...
$insertar = "INSERT INTO productos (nombre, descripcion, precio, stock, foto) VALUES ('$nombre', '$descripcion', '$precio', '$stock', '$foto')";
...
if($query){
    ...
    echo "Error al insertar el producto: " . mysqli_error($connect);
}
?>